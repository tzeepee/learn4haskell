...
sumLast2 :: Int -> Int
sumLast2 n = let lastDigit = n `mod` 10
                 vorletzteZiffer = (n `div` 10) `mod` 10
             in lastDigit + vorletzteZiffer
-- sumLast2 n = error "sumLast2: Not implemented!"

addiereZweiLetzteZiffern :: Int -> Int
addiereZweiLetzteZiffern n = letzteZiffer + vorletzteZiffer
                              where
                                  letzteZiffer = n `mod` 10
                                  vorletzteZiffer = (n `div` 10) `mod` 10
